...
const TrendingProducts = ({ product,
  ...
  return (
    <>
      ...
      >
        <div className={`card product-card ${styles.divHover}`}>
          {token ? (
            <>
              <input
                id={`heart${product.id}`}
            ...
            <>
              <div className="imageHover">
                ...
                <div className="card-body py-2 ">
                  ...
                  <div className="card-body card-body-hidden">
                    <div className="custom-control custom-option custom-control-inline mb-2" style={{ display: "flex", justifyContent: "center" }}>
                      {colorArr && colorArr?.map((c, index) => {
                        return (
                          <div className="custom-control custom-option custom-control-inline mb-2" key={c + index}>
                            <input
